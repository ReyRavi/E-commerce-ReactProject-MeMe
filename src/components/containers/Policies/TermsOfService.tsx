...
function TermsOfService() {
  return (
    <div className="policy-content">
      <div className="policy-head u-h3">Ophelia Moon Terms of Service</div>
      ...
      <ul>
        ...
        <li>
          ...
          <a href="https://ophelia-moon.com/">https://ophelia-moon.com/</a>
        </li>
        <li>
      ...
      <ul>
        <li>By email : contact@ophelia-moon.com</li>
        <li>
          By visiting this page on our website : https://ophelia-moon.com/
        </li>
